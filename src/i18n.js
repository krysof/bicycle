const dict = {
  zhHans: {
    ...
    familyMessageHelp: "可选：家人可以提前留一句鼓励，会出现在今天的路线里。",
  ...
  zhHant: {
    ...
    familyMessageLabel: "家人留言",
    familyMessageHelp: "可選：家人可以提前留一句鼓勵，會出現在今天的路線裡。",
  ...
  ja: {
    ...
    familyMessageHelp: "任意：ご家族からの励ましを今日のルートに表示できます。",
  ...
  en: {
    ...
    familyMessageHelp: "Optional: a family member can leave a kind note for today’s route.",
