const dict = {
  zhHans: {
    ...
    trafficBumpPedestrian: "阿铃：碰到散步的人了，我们先停一下，轻轻绕开。",
    trafficBumpCyclist: "阿铃：碰到骑车的人了，没关系，先稳住再走。",
    easyMode: "安心模式",
    highContrast: "高对比",
    locateTarget: "找目标",
    autoForward: "自动导航",
  ...
  zhHant: {
    ...
    trafficBumpPedestrian: "阿鈴：碰到散步的人了，我們先停一下，輕輕繞開。",
    trafficBumpCyclist: "阿鈴：碰到騎車的人了，沒關係，先穩住再走。",
    easyMode: "安心模式",
    highContrast: "高對比",
    locateTarget: "找目標",
    autoForward: "自動導航",
  ...
  ja: {
    ...
    trafficBumpPedestrian: "アリン：散歩の方に当たりました。少し止まって、ゆっくり避けましょう。",
    trafficBumpCyclist: "アリン：自転車の方に近づきました。大丈夫、落ち着いて進みましょう。",
    easyMode: "安心モード",
  ...
  en: {
    ...
    trafficBumpPedestrian: "Arin: We bumped into someone walking. Let’s pause, then go around gently.",
    trafficBumpCyclist: "Arin: We got close to a cyclist. It’s okay—steady first, then continue.",
    easyMode: "Easy mode",
