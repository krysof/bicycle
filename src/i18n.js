const dict = {
  zhHans: {
    ...
    autoObstacleStop: "阿铃：前面有障碍，我们先停一下，不绕圈也不走回头路。",
    easyMode: "安心模式",
    highContrast: "高对比",
    locateTarget: "找目标",
    autoForward: "自动导航",
    ...
    familyMessageHelp: (count) => `可选：家人可以提前留一句鼓励；系统也内置 ${count || 480} 种以上温暖留言。`,
  ...
  zhHant: {
    ...
    autoObstacleStop: "阿鈴：前面有障礙，我們先停一下，不繞圈也不走回頭路。",
    easyMode: "安心模式",
    highContrast: "高對比",
    locateTarget: "找目標",
    autoForward: "自動導航",
    ...
    familyMessageLabel: "家人留言",
    familyMessageHelp: (count) => `可選：家人可以提前留一句鼓勵；系統也內建 ${count || 480} 種以上溫暖留言。`,
  ...
  ja: {
    ...
    autoObstacleStop: "アリン：前に障害物があります。回り道や引き返しはせず、ここで待ちましょう。",
    easyMode: "安心モード",
    ...
    familyMessageHelp: (count) => `任意：ご家族の一言を表示できます。${count || 480} 種以上の温かい文例も用意しています。`,
  ...
  en: {
    ...
    autoObstacleStop: "Arin: There is an obstacle ahead. We’ll stop here instead of circling or going back.",
    easyMode: "Easy mode",
    ...
    familyMessageHelp: (count) => `Optional: family can leave a kind note; ${count || 480}+ warm built-in messages are also available.`,
