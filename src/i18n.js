const dict = {
  zhHans: {
    ...
    titleSelectCharacter: "先选择今天的送报人",
    titleSelectedMale: "已选择男送报员，将使用先生称呼。",
    titleSelectedFemale: "已选择女送报员，将使用女士称呼。",
    homeTitle: "今天骑车送报",
    ...
    defaultPlayerNames: ["春日先生", "青山女士", "松风先生", "花见女士", "高桥先生", "小野女士", "森本先生", "河合女士", "西村先生", "片山女士"],
    defaultPlayerNamesMale: ["春日先生", "松风先生", "高桥先生", "森本先生", "西村先生", "山口先生"],
    defaultPlayerNamesFemale: ["青山女士", "花见女士", "小野女士", "河合女士", "片山女士", "藤原女士"],
    ...
    summaryReady: "准备查看总结。",
    deliverDone: (i, total) => `${i}/${total} 今天的报纸都送到了`,
    ...
    trafficBumpPedestrian: "阿铃：碰到散步的人了，我们先停一下，等前面空出来。",
    trafficBumpCyclist: "阿铃：碰到骑车的人了，没关系，先稳稳停一下。",
    autoObstacleStop: "阿铃：前面有点挤，我们先稳稳停一下，等路面空出来。",
    easyMode: "安心模式",
    highContrast: "高对比",
    locateTarget: "找目标",
    autoForward: "自动导航",
    easyModeOn: "阿铃：已开启安心模式，我会把速度放慢、提示放大。",
    easyModeOff: "阿铃：安心模式已关闭，我们按普通节奏来。",
    contrastOn: "阿铃：高对比度已开启，目标会更清楚。",
    contrastOff: "阿铃：高对比度已关闭。",
    autoForwardOn: "阿铃：自动导航已开启，我会沿着道路自动前进和转弯。你可以随时关闭或按方向键接管。",
    autoForwardOff: "阿铃：自动导航已关闭。",
    locateHint: (name) => `阿铃：我已经面向${name}的方向了，沿着箭头慢慢走。`,
    landscapeHint: "建议横屏游玩，画面和按钮会更舒服。",
    familyMessageLabel: "家人留言",
    familyMessageHelp: () => "可选：家人可以提前留一句鼓励，也可以换一句温暖的话。",
    familyMessageShuffle: "换一句",
    familyMessagePlaceholder: "爸，今天慢慢骑，晚上我给你打电话。",
    familyMessageRead: (msg) => `阿铃：家人给你留了话：${msg}`,
    thankCardTitle: "今日感谢卡",
    thankCardFrom: (name) => `${name}的感谢`,
    shareCard: "复制分享卡",
    shareText: (count) => `今天完成 ${count} 户送报，收到了温暖的感谢。`,
    shareCopied: "阿铃：分享卡已复制，可以发给家人。",
    memoryPrompt: (name, paper) => `阿铃：刚才我们把「${paper}」送给了${name}，记得真清楚。`,
    miniMap: "小地图",
    miniMapLegend: "● 当前位置　◆ 目的地",
    placeKitaeguchi: "北江口",
    placeCenter: "中央住宅区",
    placeWest: "西侧街区",
    placeEast: "东侧街区",
    ...
    streetRiver: "河堤道",
    streetSchool: "学校前",
    streetCommunity: "町内会前",
    restPointHint: "阿铃：前面有休息点，累了可以按“休息”。",
  },
  zhHant: {
    lang: "zh-TW",
    stamp: "昭和町內會",
    ...
    titleSelectCharacter: "先選擇今天的送報人",
    titleSelectedMale: "已選擇男送報員，將使用先生稱呼。",
    titleSelectedFemale: "已選擇女送報員，將使用女士稱呼。",
    homeTitle: "今天騎車送報",
    ...
    defaultPlayerNames: ["春日先生", "青山女士", "松風先生", "花見女士", "高橋先生", "小野女士", "森本先生", "河合女士", "西村先生", "片山女士"],
    defaultPlayerNamesMale: ["春日先生", "松風先生", "高橋先生", "森本先生", "西村先生", "山口先生"],
    defaultPlayerNamesFemale: ["青山女士", "花見女士", "小野女士", "河合女士", "片山女士", "藤原女士"],
    ...
    summaryReady: "準備查看總結。",
    deliverDone: (i, total) => `${i}/${total} 今天的報紙都送到了`,
    ...
    trafficBumpPedestrian: "阿鈴：碰到散步的人了，我們先停一下，等前面空出來。",
    trafficBumpCyclist: "阿鈴：碰到騎車的人了，沒關係，先穩穩停一下。",
    autoObstacleStop: "阿鈴：前面有點擠，我們先穩穩停一下，等路面空出來。",
    easyMode: "安心模式",
    highContrast: "高對比",
    locateTarget: "找目標",
    autoForward: "自動導航",
    easyModeOn: "阿鈴：已開啟安心模式，我會把速度放慢、提示放大。",
    easyModeOff: "阿鈴：安心模式已關閉，我們按普通節奏來。",
    contrastOn: "阿鈴：高對比度已開啟，目標會更清楚。",
    contrastOff: "阿鈴：高對比度已關閉。",
    autoForwardOn: "阿鈴：自動導航已開啟，我會沿著道路自動前進和轉彎。你可以隨時關閉或按方向鍵接管。",
    autoForwardOff: "阿鈴：自動導航已關閉。",
    locateHint: (name) => `阿鈴：我已經面向${name}的方向了，沿著箭頭慢慢走。`,
    landscapeHint: "建議橫屏遊玩，畫面和按鈕會更舒服。",
    familyMessageLabel: "家人留言",
    familyMessageHelp: () => "可選：家人可以提前留一句鼓勵，也可以換一句溫暖的話。",
    familyMessageShuffle: "換一句",
    familyMessagePlaceholder: "爸，今天慢慢騎，晚上我給你打電話。",
    familyMessageRead: (msg) => `阿鈴：家人給你留了話：${msg}`,
    thankCardTitle: "今日感謝卡",
    thankCardFrom: (name) => `${name}的感謝`,
    shareCard: "複製分享卡",
    shareText: (count) => `今天完成 ${count} 戶送報，收到了溫暖的感謝。`,
    shareCopied: "阿鈴：分享卡已複製，可以發給家人。",
    memoryPrompt: (name, paper) => `阿鈴：剛才我們把「${paper}」送給了${name}，記得真清楚。`,
    miniMap: "小地圖",
    miniMapLegend: "● 目前位置　◆ 目的地",
    placeKitaeguchi: "北江口",
    placeCenter: "中央住宅區",
    placeWest: "西側街區",
    placeEast: "東側街區",
    ...
    streetRiver: "河堤道",
    streetSchool: "學校前",
    streetCommunity: "町內會前",
    restPointHint: "阿鈴：前面有休息點，累了可以按「休息」。",
  },
  ja: {
    lang: "ja",
    stamp: "昭和町内会",
    ...
    titleSelectCharacter: "今日の配達員を選びましょう",
    titleSelectedMale: "男性の配達員を選びました。お名前は男性向けから選びます。",
    titleSelectedFemale: "女性の配達員を選びました。お名前は女性向けから選びます。",
    homeTitle: "今日も自転車で配達",
    ...
    defaultPlayerNames: ["春日さん", "青山さん", "松風さん", "花見さん", "高橋さん", "小野さん", "森本さん", "河合さん", "西村さん", "片山さん"],
    defaultPlayerNamesMale: ["春日さん", "松風さん", "高橋さん", "森本さん", "西村さん", "山口さん"],
    defaultPlayerNamesFemale: ["青山さん", "花見さん", "小野さん", "河合さん", "片山さん", "藤原さん"],
    ...
    deliverDone: (i, total) => `${i}/${total} 今日の新聞はすべて届きました`,
    ...
    trafficBumpPedestrian: "アリン：散歩の方に当たりました。少し止まって、前が空くのを待ちましょう。",
    trafficBumpCyclist: "アリン：自転車の方に近づきました。大丈夫、まず止まって落ち着きましょう。",
    autoObstacleStop: "アリン：前が少し混んでいます。ここで落ち着いて待ちましょう。",
    easyMode: "安心モード",
    highContrast: "高コントラスト",
    locateTarget: "目標を見る",
    autoForward: "自動案内",
    easyModeOn: "アリン：安心モードを入れました。ゆっくり、見やすくします。",
    easyModeOff: "アリン：安心モードを切りました。いつものペースです。",
    contrastOn: "アリン：高コントラストにしました。目標が見やすくなります。",
    contrastOff: "アリン：高コントラストを切りました。",
    autoForwardOn: "アリン：自動案内を始めました。道路に沿って自動で進み、曲がります。いつでも方向キーで手伝えます。",
    autoForwardOff: "アリン：自動案内を止めました。",
    locateHint: (name) => `アリン：${name}の方向を向きました。矢印に沿って進みましょう。`,
    landscapeHint: "横向きで遊ぶと、画面とボタンが見やすくなります。",
    familyMessageLabel: "家族メッセージ",
    familyMessageHelp: () => "任意：ご家族の一言を表示できます。別の温かい言葉に替えることもできます。",
    familyMessageShuffle: "別の文",
    familyMessagePlaceholder: "今日はゆっくりで大丈夫。夜に電話します。",
    familyMessageRead: (msg) => `アリン：ご家族からのメッセージです。${msg}`,
    thankCardTitle: "今日のありがとうカード",
    thankCardFrom: (name) => `${name}からのありがとう`,
    shareCard: "共有カードをコピー",
    shareText: (count) => `今日は ${count} 軒に配達し、温かいありがとうをもらいました。`,
    shareCopied: "アリン：共有カードをコピーしました。ご家族に送れます。",
    memoryPrompt: (name, paper) => `アリン：さっき「${paper}」を${name}へ届けましたね。よく覚えています。`,
    miniMap: "小さな地図",
    miniMapLegend: "● いまの場所　◆ 目的地",
    placeKitaeguchi: "北江口",
    placeCenter: "中央住宅地",
    placeWest: "西側の町",
    placeEast: "東側の町",
    ...
    streetSchool: "学校前",
    streetCommunity: "町内会前",
    restPointHint: "アリン：前に休憩できる場所があります。疲れたら「休む」を押してください。",
  },
  en: {
    lang: "en",
    ...
    titleSelectCharacter: "Choose today’s delivery person",
    titleSelectedMale: "Male delivery person selected. A Mr. name will be used.",
    titleSelectedFemale: "Female delivery person selected. A Ms. name will be used.",
    ...
    defaultPlayerNames: ["Mr. Kasuga", "Ms. Aoyama", "Mr. Matsukaze", "Ms. Hanami", "Mr. Takahashi", "Ms. Ono", "Mr. Morimoto", "Ms. Kawai", "Mr. Nishimura", "Ms. Katayama"],
    defaultPlayerNamesMale: ["Mr. Kasuga", "Mr. Matsukaze", "Mr. Takahashi", "Mr. Morimoto", "Mr. Nishimura", "Mr. Yamaguchi"],
    defaultPlayerNamesFemale: ["Ms. Aoyama", "Ms. Hanami", "Ms. Ono", "Ms. Kawai", "Ms. Katayama", "Ms. Fujiwara"],
    ...
    deliverDone: (i, total) => `${i}/${total} All papers delivered today`,
    ...
    trafficBumpPedestrian: "Arin: We bumped into someone walking. Let’s pause and wait for the way to clear.",
    trafficBumpCyclist: "Arin: We got close to a cyclist. It’s okay—let’s stop steadily first.",
    autoObstacleStop: "Arin: It’s a little crowded ahead. Let’s pause here and wait for space.",
    easyMode: "Easy mode",
    highContrast: "High contrast",
    locateTarget: "Find target",
    autoForward: "Auto nav",
    easyModeOn: "Arin: Easy mode is on. I’ll slow things down and make prompts larger.",
    easyModeOff: "Arin: Easy mode is off. We’ll use the normal pace.",
    contrastOn: "Arin: High contrast is on. Targets should be clearer.",
    contrastOff: "Arin: High contrast is off.",
    autoForwardOn: "Arin: Auto navigation is on. I’ll follow the roads, move, and turn automatically. You can take over anytime.",
    autoForwardOff: "Arin: Auto navigation is off.",
    locateHint: (name) => `Arin: I turned toward ${name}. Follow the arrows gently.`,
    landscapeHint: "Landscape mode is recommended for a clearer view and easier buttons.",
    familyMessageLabel: "Family message",
    familyMessageHelp: () => "Optional: family can leave a kind note, or you can choose another warm line.",
    familyMessageShuffle: "Another",
    familyMessagePlaceholder: "Take it slowly today. I’ll call you tonight.",
    familyMessageRead: (msg) => `Arin: Your family left a message: ${msg}`,
    thankCardTitle: "Today’s thank-you cards",
    thankCardFrom: (name) => `Thanks from ${name}`,
    shareCard: "Copy share card",
    shareText: (count) => `Delivered to ${count} homes today and received warm thanks.`,
    shareCopied: "Arin: Share card copied. You can send it to family.",
    memoryPrompt: (name, paper) => `Arin: We just delivered “${paper}” to ${name}. Good remembering.`,
    miniMap: "Mini map",
    miniMapLegend: "● You　◆ Target",
    placeKitaeguchi: "Kitaeguchi",
    placeCenter: "Central homes",
    placeWest: "West block",
    placeEast: "East block",
    placeRiver: "Levee / riverbed",
    placeSchool: "School / green",
    streetMarket: "Market street",
    streetRiver: "Levee road",
    streetSchool: "School front",
    streetCommunity: "Community street",
    restPointHint: "Arin: There is a rest spot ahead. Press Rest if you feel tired.",
  },
};
