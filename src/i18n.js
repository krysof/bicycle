const dict = {
  zhHans: {
    ...
    autoForwardOn: "阿铃：自动前进已开启，你只要轻轻左右转向。",
    autoForwardOff: "阿铃：自动前进已关闭。",
  ...
  zhHant: {
    ...
    autoForwardOn: "阿鈴：自動前進已開啟，你只要輕輕左右轉向。",
    autoForwardOff: "阿鈴：自動前進已關閉。",
  ...
  ja: {
    ...
    autoForwardOn: "アリン：自動前進です。左右だけゆっくり操作してください。",
    autoForwardOff: "アリン：自動前進を止めました。",
  ...
  en: {
    ...
    autoForwardOn: "Arin: Auto forward is on. Just steer gently left and right.",
    autoForwardOff: "Arin: Auto forward is off.",
